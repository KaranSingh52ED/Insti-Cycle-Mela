...
const Navbar = () => {
    return (
        <div className='flex justify-between items-center p-8 bg-gray-200 fixed top-0 left-0 w-full h-12 sm:gap-10'>
            ...
            <form className='flex bg-black justify-center border-2 border-black  items-center  sm:rounded fixed  top-16 w-full sm:static left-0'>
            ...
            <div className='flex space-x-4 gap-5 items-center justify-end w-1/3'>
                <a href="/login" className='text-lg border-b-2 border-black hover:border-none p-1'>Login</a>
