  ...
  return (
    <Layout>
      <div className=" py-44 sm:py-20 flex items-center justify-center flex-wrap gap-10 w-5/6">
        ...
        {active && (
          <RxCross1
            className="fixed h-7 w-7  top-20 right-8 hidden sm:block"
            onClick={() => {
              setActive(!active);
            }}
          />
        ...
        {active && (
            <div
            className={`fixed bg-gray-300 sm:bg-gray-200 sm:top-28 sm:w-60 sm:right-5 sm:h-60 sm:rounded p-2 top-28 mt-1 w-full flex gap-5 overflow-auto sm:flex-col
            } transition-all duration-500 `}
          >
            <div className="flex gap-4 text-sm w-full items:center justify-between">
              <span className="font-bold">Price:</span>
              <select className="rounded sm:bg-gray-100 sm:p-2 w-2/3">
