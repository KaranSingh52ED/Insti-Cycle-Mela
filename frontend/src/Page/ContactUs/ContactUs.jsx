  ...
  return (
    <main className="pt-28 p-8 w-full font-serif text-center  ">
      ...
      <div className="flex flex-col  items-center">
        <div className="mb-10 text-left w-full  ring-1 p-4 ring-slate-300 rounded-3xl shadow-black shadow-inner max-w-lg">
        ...
        <form className="w-full max-w-lg ring-1 ring-slate-300 shadow-black shadow-inner bg-white p-8 rounded-md">
          <div className="mb-4">
            <label
